  ...
  (0, _createClass2["default"])(COSUpload, [{
    ...
    value: function () {
      var _handleUpload = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(fileList) {
        ...
        var _this$$options, tmpKeyUrl, _this$$options$authNa, authName, _this$$options$getPro, getProgress, _yield$fetch$then, bucket, region, requestAddress, dir, startTime, expiredTime, credentials, filesInfo, tmpSecretId, tmpSecretKey, sessionToken, files, cos;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this$$options = this.$options, tmpKeyUrl = _this$$options.tmpKeyUrl, _this$$options$authNa = _this$$options.authName, authName = _this$$options$authNa === void 0 ? 'TOKEN' : _this$$options$authNa, _this$$options$getPro = _this$$options.getProgress, getProgress = _this$$options$getPro === void 0 ? null : _this$$options$getPro;
                _context.next = 4;
